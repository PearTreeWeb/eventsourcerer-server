...
namespace App\Extension\Packages\PersonalData\PropertyType;
...
final readonly class PersonUniqueIdentifier implements PropertyType
{
    use PropertyTypeComparison;

    private const string DESCRIPTION = 'Person Unique Identifier';
    ...
    {
        return Package::fromString(Packages::PersonalData->value);
    }
