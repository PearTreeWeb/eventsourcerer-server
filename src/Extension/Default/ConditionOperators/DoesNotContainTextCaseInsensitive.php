...
final readonly class DoesNotContainTextCaseInsensitive extends SystemConditionOperator
{
    /**
     * @param string $value
    ...
    {
        return ConditionLabel::fromString('Does not contain text (case insensitive)');
    }
}
