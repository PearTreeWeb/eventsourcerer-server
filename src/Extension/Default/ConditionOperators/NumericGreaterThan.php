...
final readonly class NumericGreaterThan extends SystemConditionOperator
{
    /**
     * @param T $value
     * @param T $parameter
    ...
    public function compute(mixed $value, mixed $parameter): bool
    {
        return new Number($value)
            ->compare(new Number($parameter)) === 1;
    }

    public static function label(): ConditionLabel
    {
        return ConditionLabel::fromString('Numeric greater than');
    }
